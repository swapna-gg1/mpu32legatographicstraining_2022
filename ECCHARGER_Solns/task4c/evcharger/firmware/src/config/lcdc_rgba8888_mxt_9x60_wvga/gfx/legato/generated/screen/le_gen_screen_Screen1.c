...
leResult screenShow_Screen1(void)
{
    ...
    Screen1_LabelWidget_13->fn->setString(Screen1_LabelWidget_13, (leString*)&string_charge_percent);
    ...
    Screen1_ButtonWidget_plus->fn->setSize(Screen1_ButtonWidget_plus, 67, 61);
    ...
    Screen1_ImageSequenceWidget_0->fn->setPosition(Screen1_ImageSequenceWidget_0, 558, 342);
